...
import com.codingwithmitch.kotlinrecyclerviewexample.models.Albums
...
class BlogRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    constructor(
        ...
        val imagePath = itemView.blog_image
        val folderNames = itemView.blog_title
        val imgCount = itemView.blog_author
        ...
        fun bind(album: Albums){
            ...
            imgCount.setText(album.imgCount)
